...
class Noms(commands.Cog):
    ...
    async def nominate(self, ctx: commands.Context):
        ...
        embed = discord.Embed(
            title="welcome to the realm of portals apm of the month nomination!!",
        ...
        try:
            ...
            embed = discord.Embed(
                title="who do you think should be the __new pm of july__?",
            ...
            try:
                ...
                embed = discord.Embed(
                    title="__why__ do you think they should be the __new pm of july__?",
                    description="please make sure they have the 'new apm' role.",
                    color=0xFDFDBE,
                )
                await ctx.send(embed=embed)
                try:
                    ...
                    embed = discord.Embed(
                        title="who do you think should be the __new am of july__?",
                        description="please make sure they have the 'new apm' role.",
                        color=0xFDFDBE,
                    )
                    embed.set_footer(text="e.g. toby#0508, 477096301364903936")
                    ...
                    try:
                        ...
                        embed = discord.Embed(
                            title="__why__ do you think they should be the __new am of july__?",
                            description="please make sure they have the 'new apm' role.",
                            color=0xFDFDBE,
                        )
                        await ctx.send(embed=embed)
                        try:
                            ...
                            embed = discord.Embed(
                                title="who do you think should be the __experienced pm of july__?",
                            ...
                            try:
                                ...
                                embed = discord.Embed(
                                    title="__why__ do you think they should be the __experienced pm of july__?",
                                    description="please make sure they have the 'experienced apm' role.",
                                    color=0xFDFDBE,
                                )
                                await ctx.send(embed=embed)
                                                ...
                                                try:
                                                    ...
                                                    try:
                                                        ...
                                                        try:
                                                            ...
                                                            embed = discord.Embed(
                                                                title=f'nomination from {response["nominator"]}',
                                                                color=0xFDFDBE,
